...
import Announcement from "./StudentAnnouncement"; // Import the Announcement component
import People from "./StudentPeople"; // Import the People component
import Classwork from "./StudentClasswork"; // Import the Classwork component
